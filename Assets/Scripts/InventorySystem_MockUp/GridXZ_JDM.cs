...
public class GridXZ_JDM<TGridObject>
{
    ...
    public GridXZ_JDM(int width, int height, float cellSize, Vector3 originPosition, Func<GridXZ_JDM<TGridObject>, int, int, TGridObject> createGridObject)
    {
        this.width = width;
        this.height = height;
